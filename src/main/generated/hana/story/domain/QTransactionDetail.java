...
public class QTransactionDetail extends EntityPathBase<TransactionDetail> {
    ...
    public final NumberPath<Long> transactionDetailIdx = createNumber("transactionDetailIdx", Long.class);
    ...
    public QTransactionDetail(Class<? extends TransactionDetail> type, PathMetadata metadata, PathInits inits) {
        ...
        this.transaction = inits.isInitialized("transaction") ? new hana.account.domain.QTransaction(forProperty("transaction"), inits.get("transaction")) : null;
