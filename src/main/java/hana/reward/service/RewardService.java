...
public class RewardService {
    ...
    public RewardQuestionQuizResDto getRandomQuiz() {
        ...
        RewardQuestionQuizResDto.Data data = RewardQuestionQuizResDto.Data.builder()
    ...
    public RewardAnswerQuizResDto isCollect(Long studentIdx, RewardAnswerQuizReqDto rewardAnswerQuizReqDto) {
        Quiz findQuiz = quizRepository.findById(rewardAnswerQuizReqDto.getQuizIdx()).orElseThrow(IllegalArgumentException::new);
        ...
        if (rewardAnswerQuizReqDto.getAnswer() == findQuiz.getQuizAnswer()) {
            ...
            findStudent.ifPresent(student -> deptRepository.updatePointByDeptIdx(student.getDept().getDeptIdx()));

            RewardAnswerQuizResDto.Data data = RewardAnswerQuizResDto.Data.builder()
                    .isCorrect(true)
    ...
    public RewardService(QuizRepository quizRepository, StudentRepository studentRepository, DeptRepository deptRepository) {
