...
public class FCMService {
    ...
    public int sendMessageTo(FcmSendReqDto fcmSendReqDto) throws IOException {
        ...
        ResponseEntity response = restTemplate.exchange(FCM_URL, HttpMethod.POST, entity, String.class);
    ...
    private String getAccessToken() throws IOException {
        GoogleCredentials googleCredentials = GoogleCredentials.fromStream(new ClassPathResource(GOOGLE_APPLICATION_CREDENTIALS).getInputStream()).createScoped(List.of("https://www.googleapis.com/auth/cloud-platform"));
    ...
    private String makeMessage(FcmSendReqDto fcmSendReqDto) throws JsonProcessingException {
        ...
        FcmMessageResDto fcmMessageResDto = FcmMessageResDto.builder()
